...
"""
    ...
    def network_capture(self):
        ...
        try:
            ...
            logging.info("Network capture started.")
            ...
            print(f"An error occurred during network capture: {str(e)}")
            logging.error(f"An error occurred during network capture: {str(e)}")
